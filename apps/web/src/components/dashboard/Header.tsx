    ...
    <header className="sticky top-0 z-50 border-b bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Toggle Dark/Light — convenção "ícone reflete o estado atual":
              dark → Lua; light → Sol.
              Enquanto `mounted` é false (durante SSR e antes do cliente
              determinar o tema real), exibimos um placeholder neutro para
